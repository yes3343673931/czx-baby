export function IridescentBg({ className = "fixed inset-0" }: { className?: string }) {
  return (
    <div className={`${className} bg-gradient-to-b from-transparent via-white/80 to-[#e6f0f5] z-0 overflow-hidden pointer-events-none`}>
