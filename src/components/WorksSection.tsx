...
export function WorksSection() {
  ...
  return (
    <section className="py-24 md:py-32 px-8 md:px-16 lg:px-24 relative z-10 w-full min-h-screen text-neutral-900">
      <div className="max-w-[1600px] mx-auto relative z-10">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-sm md:text-base font-medium tracking-[0.3em] text-ocean-400 uppercase mb-4">
          ...
          <motion.div
            ...
            className="flex items-center gap-2 text-ocean-400 hover:text-neutral-900 font-medium link-hover cursor-pointer"
            onClick={() => {
                ...
                >
                    ...
                    <div className="relative w-full h-full bg-white shadow-lg overflow-hidden border border-neutral-200 z-10 transition-transform duration-500 group-hover:-translate-y-1 group-hover:shadow-xl">
                      ...
                      <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center z-30">
                        <div className="w-12 h-12 rounded-full border border-white/30 flex items-center justify-center backdrop-blur-sm transform scale-50 group-hover:scale-100 transition-transform duration-500">
                          <Play className="w-5 h-5 text-neutral-900 fill-current translate-x-0.5" />
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="w-full max-w-[200px] md:max-w-[240px] lg:max-w-[300px]">
                    <div className="flex items-center justify-center gap-2 mb-1.5">
                      <span className="text-[9px] font-bold tracking-[0.2em] text-ocean-300 px-2 py-0.5 bg-ocean-500/20 rounded-full uppercase">
                        Album
                      </span>
                    ...
                    <h4 className="text-base md:text-lg font-medium text-neutral-900 tracking-wide mb-1.5 group-hover:text-ocean-400 transition-colors">
                      {album.title}
                    </h4>
                    <p className="text-xs text-neutral-400 leading-relaxed line-clamp-2 italic font-light">
