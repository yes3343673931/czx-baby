            ...
            >
              ...
              >
                ...
                <div 
                  ...
                  style={{ 
                    background: 'repeating-radial-gradient(circle, #1a1a1a 0px, #050505 1px, #1a1a1a 2px)',
                    opacity: 0.4
                  }} 
                />
              ...
              <div className="absolute top-0 right-0 w-32 h-64 pointer-events-none z-30">
                <motion.div 
                  animate={isPlaying ? { rotate: 5, x: -10, y: 10 } : { rotate: -25, x: 0, y: 0 }}
                ...
                >
                  ...
                  <div className="absolute top-10 right-8 w-1.5 h-48 bg-neutral-100 rounded-full shadow-lg origin-top" 
                       style={{ transform: 'rotate(-5deg)' }} />
                  <div className="absolute top-[204px] right-10 w-6 h-10 bg-white border border-ocean-100 rounded shadow-md flex flex-col items-center p-1"
                       style={{ transform: 'rotate(-5deg)' }}>
                    ...
                    >
                      <div className="relative w-12 h-12 flex items-center justify-center shrink-0">
                        {isCurrent ? (
                          ...
                          <Music2 className="w-6 h-6 text-ocean-900/20 group-hover:text-ocean-900 transition-colors" />
                        )}
                      </div>
