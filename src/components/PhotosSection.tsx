  ...
  return (
    <section className="relative w-full min-h-screen flex flex-col justify-center">
      <AnimatePresence mode="wait">
        {isLoading && (
          <DolphinLoader key="loader" onComplete={handleLoadComplete} />
        )}
        ...
        {!showGallery && !isLoading && (
          ...
          >
            ...
            <div className="absolute -inset-x-0 -top-0 -bottom-[20vh] bg-gradient-to-b from-[#021035] via-[#0b3370] to-transparent z-0 opacity-90" />
              ...
              <div className="flex-1 w-full flex flex-col items-center justify-start">
                ...
                >
                  <div className="flex items-center justify-center gap-4 mb-4">
                    ...
                    <h2
                      className="text-5xl md:text-[85px] text-white tracking-[0.1em] leading-tight"
                      style={{
        ...
        {showGallery && !isLoading && (
          <motion.div
            ...
            className="relative w-full py-24 px-8 md:px-24 bg-white min-h-screen"
          >
            {/* Go Back Button */}
            <button
                  ...
                  >
                    {currentPhotos.map((photo) => {
                      ...
                      return (
                        <div
                          key={photo.id}
                          className="group flex flex-col bg-white shadow-[0_10px_30px_rgba(0,0,0,0.06)] hover:shadow-[0_20px_40px_rgba(0,0,0,0.12)] transition-shadow duration-300"
                        >
                          ...
                          <div className="p-5 flex flex-col gap-4">
                            ...
                            <div className="flex items-center gap-6 text-xs text-neutral-400 font-medium tracking-wider">
                              <div className="flex items-center gap-1.5">
                                ...
                                <span>
                                  {photo.downloads.toLocaleString()} 下载量
                                </span>
                              </div>
                              <div className="flex items-center gap-1.5">
                ...
                <button
                  ...
                  className={`w-10 h-10 rounded-full flex items-center justify-center transition-colors ${
                    page >= totalPages - 1
                      ...
                      : "bg-[#336799] text-neutral-900 hover:bg-ocean-800 shadow-md"
                  }`}
                >
